...
Sombe Core version *version* is now available from:  <https://github.com/sombeProject/sombe/releases>
...
Sombe Core is extensively tested on multiple operating systems using the Linux kernel, macOS 10.8+, and Windows 7 and later.
