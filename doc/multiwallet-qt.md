...
In order to support loading of multiple wallets in sombe-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sombe.cpp.
...
Changes to sombe.cpp
----------------------
sombe.cpp is the entry point into sombe-qt, and as such, will require some minor modifications to provide hooks for
