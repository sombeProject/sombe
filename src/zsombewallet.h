...
#ifndef SBE_ZSBEWALLET_H
#define SBE_ZSBEWALLET_H
...
public:
    CzSBEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSBE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSBE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
