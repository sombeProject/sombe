...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a SBE address (e.g. %1)").arg("SZxtqeikCu3ivTMXFvox44uPJPJbXwCSB4"));
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SBE.lnk";
}
