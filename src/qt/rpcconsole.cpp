                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSBEPathCustom = GetArg("-zsombebackuppath", "");
    ...
    if(!strzSBEPathCustom.empty()) {
        ui->wallet_customzsombebackuppath->setText(QString::fromStdString(strzSBEPathCustom));
        ui->wallet_customzsombebackuppath_label->setVisible(true);
        ui->wallet_customzsombebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSBEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SBE RPC console.") + "<br>" +
