...
static void NotifyzSBEReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzSBEReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzSBEReset.connect(boost::bind(NotifyzSBEReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzSBEReset.disconnect(boost::bind(NotifyzSBEReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zsombeTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
