...
extern UniValue setzsombeseed(const UniValue& params, bool fHelp);
extern UniValue getzsombeseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsombe(const UniValue& params, bool fHelp);
extern UniValue dzsombestate(const UniValue& params, bool fHelp);
