...
// Copyright (c) 2015-2018 SOMBE developers
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue zsombeObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zsombeObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zsombeObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"zSBEsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSBE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSBE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSBE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSBE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSBE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSBE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSBE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSBE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSBE denominations\n"
            "  }\n"
            "}\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, 100, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), ZSBE_FAILED_ACCUMULATOR_INITIALIZATION);
