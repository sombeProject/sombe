...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "sombe" is a composite category enabling all SBE-related debug output
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\SBE
// Windows >= Vista: C:\Users\Username\AppData\Roaming\SBE
// Mac: ~/Library/Application Support/SBE
// Unix: ~/.sombe
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SBE";
#else
    fs::path pathRet;
