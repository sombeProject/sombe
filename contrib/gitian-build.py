...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/sombeProject/gitian.sigs.git'])
    if not os.path.isdir('SOMBE-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/sombeProject/SBE-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('sombe'):
        subprocess.check_call(['git', 'clone', 'https://github.com/sombeProject/sombe.git'])
...
def build():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/sombe-*.zip build/out/sombe-*.exe ../Sombe-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/sombe-*.tar.gz build/out/sombe-*.dmg ../Sombe-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call(['bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../sombe/contrib/gitian-descriptors/gitian-win-signer.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../sombe/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def verify():
    ...
    if args.linux:
        ...
        subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../sombe/contrib/gitian-descriptors/gitian-linux.yml'])
        print('\nVerifying v'+args.version+' Linux\n')
        subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../sombe/contrib/gitian-descriptors/gitian-linux.yml'])

    if args.windows:
        print('\nVerifying v'+args.version+' Windows\n')
        subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../sombe/contrib/gitian-descriptors/gitian-win.yml'])
        if args.sign:
            print('\nVerifying v'+args.version+' Signed Windows\n')
            subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../sombe/contrib/gitian-descriptors/gitian-win-signer.yml'])

    if args.macos:
        print('\nVerifying v'+args.version+' MacOS\n')
        subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../sombe/contrib/gitian-descriptors/gitian-osx.yml'])
        if args.sign:
            print('\nVerifying v'+args.version+' Signed MacOS\n')
            subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../sombe/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/sombeProject/SBE', help='Specify the URL of the repository. Default is %(default)s')
